...
- `summary_quote` ≤ 280 characters. The single most important takeaway, formatted as the abbreviated alignment grade line (e.g., "Aim alignment: 4/10 — security gaps directly contradict 'secure' criterion in aims; hold for fixes before ship.").
...
```json
{
  ...
  "location": "tests/fixtures/nextjs-auth/.review/aims.md:11-14",
...
```json
{
  ...
  "findings": [
    ...
    },
    {
      ...
      "location": "tests/fixtures/nextjs-auth/.review/aims.md:11-12",
